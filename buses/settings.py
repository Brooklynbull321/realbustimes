...
WATCHBODS_WEBHOOK_URL = os.environ.get("WATCHBODS_WEBHOOK_URL")
LOCAL_LOCK_WEBHOOK_URL = os.environ.get("LOCAL_LOCK_WEBHOOK_URL")
...
# captchas
TURNSTILE_SITEKEY = os.environ.get("TURNSTILE_SITEKEY", "0x4AAAAAABL_sDp4SFZwGbwz")
